...
import {
  ArrowLeft, ArrowRight, BarChart3, Bell, Check, ChevronRight, CircleHelp, FileText, LayoutDashboard,
...
function App() {
  ...
  if (path === '/admin') {
    ...
    if (!signedIn) return <AdminLogin onBack={() => navigate('/')} />
